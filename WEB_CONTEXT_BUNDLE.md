...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.13-kirby-problem-2.13-a88e30d1-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.13"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.13-kirby-problem-2.13-a88e30d1-v1",
      "problem_contract_sha256": "771d6010b158775c67a08e4990062aeb068b9768e299ae49c46a0eb1991c34f9",
      "problem_id": "problem:um-kp-2.13-kirby-problem-2.13-a88e30d1",
      "route_id": "route:um-kp-2.13-kirby-problem-2.13-a88e30d1-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.13-kirby-problem-2.13-a88e30d1-source-fidelity-01",
      "graph_id": "graph:um-kp-2.13-kirby-problem-2.13-a88e30d1-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.13-kirby-problem-2.13-a88e30d1-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.13-kirby-problem-2.13-a88e30d1-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $S$ be a surface, and let $\\Gamma_{1}, \\Gamma_{2}$ be isotopy classes of embedded graphs in $S$. Determine when $\\Gamma_{1}$ and $\\Gamma_{2}$ are related by a sequence of surgeries."
          },
          "statement_sha256": "cc4914ed845bef91fa77c0456613cd86e2846b1581acf9e4b7874389058fcc74"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.13-kirby-problem-2.13-a88e30d1-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.13-kirby-problem-2.13-a88e30d1-root",
      "route_id": "route:um-kp-2.13-kirby-problem-2.13-a88e30d1-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.13-b5a645ba8626",
        "url": "https://www.unsolvedmath.com/problems/KP-2.13"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
